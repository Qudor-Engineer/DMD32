...
#define PIN_DMD_A 12      // D19, 12 if HSPI
#define PIN_DMD_B 21      // D21
#define PIN_DMD_CLK 14    // D18_SCK  is SPI Clock if SPI is used, 14 if HSPI
#define PIN_DMD_SCLK 2    // D02
#define PIN_DMD_R_DATA 13 // D23_MOSI is SPI Master Out if SPI is used, 13 if HSPI
